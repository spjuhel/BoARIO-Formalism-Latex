\chapter{Description of the ARIO indirect economic cost model}\label{ch_boario}

\addcontentsline{lof}{chapter}{Chapter 3 -- Description of the ARIO indirect economic cost model}
\addcontentsline{lot}{chapter}{Chapter 3 -- Description of the ARIO indirect economic cost model}
...
description in appendix~\Cref{sec:full-description-ARIO} where we provide a more
